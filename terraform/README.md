...
| [aws_iam_role_policy_attachment.process_lambda_role_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_process_json_lambda"></a> [process\_json\_lambda](#input\_process\_json\_lambda) | Configuration for the Process JSON Lambda function | <pre>object({<br/>    function_name = optional(string, "eventpulse_process_json_lambda_function")<br/>    role_name     = optional(string, "eventpulse_process_json_lambda_role")<br/>    policy_name   = optional(string, "eventpulse_process_json_lambda_policy")<br/>    runtime       = optional(string, "python3.12")<br/>  })</pre> | `{}` | no |
