...
| <a name="input_dynamodb_table"></a> [dynamodb\_table](#input\_dynamodb\_table) | Configuration for the DynamoDB table | <pre>object({<br/>    name           = optional(string, "event-pulse-table")<br/>    read_capacity  = optional(number, 1)<br/>    write_capacity = optional(number, 1)<br/>    hash_key       = optional(string, "ArtistID")<br/>    range_key      = optional(string, "ItemID")<br/>  })</pre> | n/a | yes |
